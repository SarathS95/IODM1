...
players[1] = 'Cristiano Ronaldo'; //['Mo Salah', 'Cristiano Ronaldo', 'Pep Guardiola', 'Sadio Mane', 'Marcus Rashford']
console.log(players);

players[4] = 'David Beckham'; //['Mo Salah', 'Cristiano Ronaldo', 'Pep Guardiola', 'Sadio Mane', 'David Beckham']
console.log(players);
